...
function Placeorder(){
    ...
    return <div className="min-h-[calc(100vh-6rem)] p-6 max-w-6xl mx-auto" >
        <div className="flex  mt-30 gap-40 text-gray-600 uppercase font-bold justify-center items-center " >
            <div className="mt-5" >
                <h1 className="text-4xl text-yellow-600">deliver information</h1>
                <div className="mt-5 flex flex-wrap">
                    <input type="text"placeholder="First Name" className="border-2 p-4 rounded-4xl text-sm "/>
                      <input type="text "placeholder="Last Name" className="border-2 p-4 rounded-4xl text-sm"/>

                </div>
                <input type="email"placeholder="Email Address" className="border-2 p-4 rounded-4xl text-sm "/>
                <input type="text"placeholder="Street" className="border-2 p-4 rounded-4xl text-sm mt-4 "/>
                <div className="flex  items-center justify-center">
                    <input type="text"placeholder="City" className="border-2 p-4 rounded-4xl text-sm mt-4 " />
                    <input type="text" placeholder="State" className="border-2 p-4 rounded-4xl text-sm mt-4 " />
                   
                </div>
                 <input type="number"placeholder="Pincode" className="border-2 p-4 rounded-4xl text-sm mt-4 " />
                    <input type="number"placeholder="Phonenumber" className="border-2 p-4 rounded-4xl text-sm mt-4 " />
            </div>
            <div className="">
