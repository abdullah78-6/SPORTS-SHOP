...
function Navbar(){
    ...
    return <div className=" flex items-center px-6 justify-between  py-3 shadow-none font-bold md:shadow-md lg:shadow-md">
        
        <a href="#h"><h1 className="font-bold text-sm md:text-3xl lg:text-3xl text-blue-600 cursor-pointer xl:text-4xl  lg:text-3xl ">SPORTS-SHOP</h1></a>
        
        <ul className=" hidden md:flex gap-6 font-bold text-2xl text-gray-600 cursor-pointer xl:flex gap-6 font-bold text-2xl text-gray-600 cursor-pointer md:flex gap-6 font-bold lg:text-2xl xl:text-2xl md:text-sm text-gray-600 cursor-pointer ">
        ...
        <div className="flex items-end  gap-4  font-bold mt-[-20px] mr-5 text-2xl lg:text-sm md:items-center lg:items-center">
            ...
            <button className="bg-blue-600 text-white p-[4px] md:p-1 text-sm md:text-lg lg:text-2xl xl:text-3xl rounded-2xl mt-3 hover:bg-white      hover:text-blue-600" onClick={()=>setlogin(true)}>SIGN-UP</button>
        </div>
