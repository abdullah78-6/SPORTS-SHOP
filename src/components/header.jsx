function Header(){
    return <div className="flex justify-center items-center mt-40 flex-wrap  ">
        <div className="">
            ...
            <p className="text-4xl w-250 font-semibold text-gray-600">From basketballs to footballs and everything in between — find top-quality gear that keeps your game strong.</p>
