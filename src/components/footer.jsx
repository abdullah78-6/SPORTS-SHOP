  ...
  return (
    <div className="bg-gray-800 text-white py-10 px-6 flex flex-wrap justify-between items-start gap-10" >
      ...
      <div className="max-w-sm ">
        <h1 className="text-4xl lg:text-3xl font-bold text-yellow-500 mb-3">SPORTS-SHOP</h1>
      ...
      <div className="max-w-sm">
        ...
        <div className="flex items-center flex-wrap">
          ...
          />
          <button className="bg-yellow-500 text-gray-900 px-4 py-2 rounded-4xl font-bold hover:bg-yellow-400 mt-5 md:mt-0 lg:mt-0">
            Subscribe
          </button>
        </div>
      </div>
